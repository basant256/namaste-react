...
const RestrauntCard = (props) => {
    ...
    const {name,cuisines,avgRating,sla,cloudinaryImageId} = props.obj.info;
    return (
        <div className="res-card">
            <div className="eNZkiz">
            ...
            <div className="restraunt-name">{name}</div>
                <div className="sw-restaurant-card-subtext-container">
                    <div>
                        ...
                        <span className="sc-aXZVg cbhbwm"> {avgRating} • </span>{sla.slaString}
                        
                    </div>
                    
                </div>
                <div className="cusine-names">{cuisines.join(",")}</div>                
